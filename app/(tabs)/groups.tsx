...
type SpaceFilter = 'unread' | 'groups';
...
const inboxItems = useMemo<SpaceInboxItem[]>(() => {
  ...
  return visibleItems.sort((a, b) => b.updatedAt - a.updatedAt);
}, [groupMemberSearchTextByGroupId, groupPreviewOverrides, groupUnreadCounts, groups, search, spaceFilter]);
...
const loadingInitialSpaces = loadingInitialGroups;
  const headerLogo =
    themeMode === 'light'
